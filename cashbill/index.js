...
class CashBill extends HttpClient{
    ...
    // Kolejność jest ważna!!! (Ważne przy ustawianiu dodatkowych parametrów niż te wymagane)
    // title + amount.value + amount.currencyCode + returnUrl + description +
    // negativeReturnUrl + additionalData + paymentChannel + languageCode +
    // referer + personalData.firstName + personalData.surname +
    // personalData.email + personalData.country + personalData.city +
    // personalData.postcode + personalData.street + personalData.house +
    // personalData.flat + secretPhrase
